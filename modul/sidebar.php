  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        <li>
          <a href="#">
            <i class="bi bi-circle"></i><span>Sewakan Kamar</span>
          </a>
        </li>
        <li>
          <a href="#">
            <i class="bi bi-circle"></i><span>Perpanjang Sewa</span>
          </a>
        </li>
        <li>
          <a href="#">
            <i class="bi bi-circle"></i><span>Terima Kunci</span>
          </a>
        </li>
        <li>
          <a href="#">
            <i class="bi bi-circle"></i><span>History Sewa</span>
          </a>
        </li>
      </ul>
    </li>
      ...
      <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        <li>
          <a href="tables-general.html">
            <i class="bi bi-circle"></i><span>Tagihan Bulanan</span>
          </a>
        </li>
        <li>
          <a href="tables-data.html">
            <i class="bi bi-circle"></i><span>Pemasukan Bulanan</span>
          </a>
        </li>
      </ul>
    </li><!-- End Tables Nav -->
      ...
      <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        <li>
          <a href="#charts-chartjs.html">
            <i class="bi bi-circle"></i><span>Grafik Penyewa Bulanan</span>
          </a>
        </li>
        <li>
          <a href="#charts-apexcharts.html">
            <i class="bi bi-circle"></i><span>Grafik Pemasukan Bukanan</span>
          </a>
        </li>
      </ul>
    </li>
